...
export function renderSidePanel(state, tabsEl, rightEl, onTabChange, onNavigate, onGraphPhaseClick) {
    ...
    const diag = state.mode === 'npc' ? state.npc.diag : state.mode === 'dialogue' ? state.dialogue.diag : state.quest.diag;
