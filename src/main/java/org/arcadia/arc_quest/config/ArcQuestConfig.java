...
public final class ArcQuestConfig {
    ...
    public static final ModConfigSpec.BooleanValue SHOW_QUEST_JOURNAL_MARK_ALL_READ_BUTTON;
    public static final ModConfigSpec.BooleanValue SHOW_GUIDE_MARK_ALL_READ_BUTTON;
