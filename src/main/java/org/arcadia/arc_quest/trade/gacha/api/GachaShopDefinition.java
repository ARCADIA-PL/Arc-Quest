...
public class GachaShopDefinition {
    ...
    // 代理方法 - 访问底层商店定义
    public TradeShopDefinition getShopDefinition() { return shopDefinition; }
    public String getShopId() { return shopDefinition.getShopId(); }
    public Component getDisplayName() { return shopDefinition.getDisplayName(); }
    public List<TradeCategory> getCategories() { return shopDefinition.getCategories(); }
    public Collection<TradeEntry> getAllEntries() { return shopDefinition.getAllEntries(); }
    @Nullable
    public TradeEntry getEntry(String entryId) { return shopDefinition.getEntry(entryId); }
    public boolean isSimpleMode() { return shopDefinition.isSimpleMode(); }
    public int getThemeColor() { return shopDefinition.getThemeColor(); }
    public SoundEvent getOpenSound() { return shopDefinition.getOpenSound(); }
    public SoundEvent getCloseSound() { return shopDefinition.getCloseSound(); }
    
    // 抽奖特有方法
    public GachaPool getGachaPool() { return gachaPool; }
    public ITradeOffer getDrawCost() { return drawCost; }
    ...
    @Nullable
    public ICondition getDrawCondition() { return drawCondition; }
    ...
    @Nullable
    public SoundEvent getDrawCooldownSound() { return drawCooldownSound; }
    
    @Nullable
    public SoundEvent getDrawLimitReachedSound() { return drawLimitReachedSound; }
    
    @Nullable
    public SoundEvent getDrawConditionFailSound() { return drawConditionFailSound; }
