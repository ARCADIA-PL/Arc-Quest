...
public final class QuestRejectCodeDictionary {
    ...
    public enum Code {
        ...
        COLLECTION_REWARD_ID_INVALID,
        COLLECTION_REWARD_NOT_UNLOCKED,
        COLLECTION_REWARD_ALREADY_CLAIMED,
        COLLECTION_REWARD_NOT_MANUAL,
        COLLECTION_REWARD_NODE_NOT_FOUND,
