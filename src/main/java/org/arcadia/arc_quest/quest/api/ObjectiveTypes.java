...
public final class ObjectiveTypes {
    ...
    public static final ObjectiveType CRAFT = registerBuiltin("craft", true, true, "arc_quest.objective.craft", "item");
    public static final ObjectiveType OFFER = registerBuiltin("offer", true, true, "arc_quest.objective.offer", "item_or_tag");
    public static final ObjectiveType CUSTOM = registerBuiltin("custom", true, true, "arc_quest.objective.custom", "custom");
