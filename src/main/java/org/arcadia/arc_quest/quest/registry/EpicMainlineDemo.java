        ...
        ArcQuestAPI.registerQuest(
                QuestBuilder.create("arc_quest:epic_prologue")
                        ...
                        .phase(PhaseBuilder.create("arc_quest:start")
                                ...
                                .thenGoTo("arc_quest:gather_wood"))
                        ...
                        .phase(PhaseBuilder.create("arc_quest:scout_forest")
                                ...
                                .intelScene("arc_quest:epic_prologue", "arc_quest:defend_village")
                                .story("文本1文本1文本1文本1文本1文本1文本1文本1文本1文本1文本1文本1“\n“文本1文本1文本1文本1文本1文本1文本1文本1文本1文本1文本1文本1”\n“文本1文本1文本1文本1文本1文本1文本1文本1文本1文本1文本1文本1”")
                        ...
                        .phase(PhaseBuilder.create("arc_quest:reinforce_gate2")
                                ...
                                .objective(ObjectiveBuilder.offerTag(ItemTags.DOORS.location(), 8)
                                        .display(Component.translatable("arc_quest.objective.epic_prologue.reinforce_gate2.0")))
                                .objective(ObjectiveBuilder.offerTag(ItemTags.STONE_BRICKS.location(), 8)
                                        .display(Component.translatable("arc_quest.objective.epic_prologue.reinforce_gate2.1")))
                                .objective(ObjectiveBuilder.offerTag(ItemTags.BIRCH_LOGS.location(), 8)
                                        .display(Component.translatable("arc_quest.objective.epic_prologue.reinforce_gate2.2")))
                        ...
                        .phase(PhaseBuilder.create("arc_quest:defend_village")
                                ...
                                .objective(ObjectiveBuilder.kill(EntityType.ZOMBIE, 2)
                                        .display(Component.translatable("arc_quest.objective.epic_prologue.defend_village.0")))
                                .objective(ObjectiveBuilder.kill(EntityType.HUSK, 2)
