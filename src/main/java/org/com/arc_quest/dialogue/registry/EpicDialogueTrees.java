...
public final class EpicDialogueTrees {
    ...
    private static void registerVillageGuard() {
        DialogueTreeBuilder.create("epic_village_guard")
                ...
                // ═══════════════════════════════════════════
                .node("intro")
                .say(Component.translatable("dialogue.epic_village_guard.intro.text").getString())
                .choice(Component.translatable("dialogue.epic_village_guard.intro.choice_ok").getString(),
                        c -> c.goTo("start"))
                ...
                // ═══════════════════════════════════════════
                .node("daily_patrol")
                .say(Component.translatable("dialogue.epic_village_guard.daily_patrol.text").getString())
                .choice(Component.translatable("dialogue.epic_village_guard.daily_patrol.choice_thanks").getString(),
                        c -> {
                ...
                // ═══════════════════════════════════════════
                .node("training")
                .say(Component.translatable("dialogue.epic_village_guard.training.text").getString())
                .choice(Component.translatable("dialogue.epic_village_guard.training.choice_thanks").getString(),
                        DialogueTreeBuilder.ChoiceBuilder::close)
                ...
                .say(Component.translatable("dialogue.epic_village_guard.chat.default").getString())
    ...
    private static void registerMysteriousMerchant() {
        DialogueTreeBuilder.create("epic_mysterious_merchant")
                ...
                // 选项3：离开
                .choice(Component.translatable("dialogue.epic_mysterious_merchant.start.choice_leave").getString(),
                        DialogueTreeBuilder.ChoiceBuilder::close)
                ...
                // 返回
                .choice(Component.translatable("dialogue.epic_mysterious_merchant.shop.choice_back").getString(),
                        c -> c.goTo("start"))
                ...
                // ═══════════════════════════════════════════
                .node("identity")
                .say(Component.translatable("dialogue.epic_mysterious_merchant.identity.text").getString())
