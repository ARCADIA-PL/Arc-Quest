...
public record DialogueNode(
    ...
    public static class Builder {
        ...
        public Builder speaker(DialogueText s) { this.speaker = s; return this; }
        public Builder speaker(String s) { this.speaker = DialogueText.literal(s); return this; }
        public Builder text(DialogueText t) { this.text = t; return this; }
        public Builder text(String t) { this.text = DialogueText.literal(t); return this; }
        public Builder conditionalTexts(Map<String, ConditionalSay> ct) { this.conditionalTexts = ct; return this; }
        ...
        public Builder cooldown(long seconds) { this.cooldownSeconds = seconds; this.cooldownType = CooldownType.SECONDS; return this; }
        public Builder cooldownGameDay() { this.cooldownSeconds = 1; this.cooldownType = CooldownType.GAME_DAY; return this; }
        public Builder cooldownAtTick(int tick) { this.cooldownSeconds = 1; this.cooldownType = CooldownType.GAME_TICK; this.resetTimeTicks = Math.max(0, Math.min(tick, 24000)); return this; }
        public Builder cooldownType(CooldownType type) { this.cooldownType = type; return this; }
        public Builder resetTimeTicks(int ticks) { this.resetTimeTicks = Math.max(0, Math.min(ticks, 24000)); return this; }
        public Builder enterSound(SoundEvent sound) { this.nodeEnterSound = sound; return this; }
